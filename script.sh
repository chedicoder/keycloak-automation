...
export ECM_EOC_PCS_ENV_URL="ecm-eoc-pcs.msictst.iamdg.net.ma"
export APP_ENV_URL="app.msictst.iamdg.net.ma"
...
curl -s -k -X POST $KEYCLOAK_URL/auth/admin/realms   -H "Authorization: Bearer $ADMIN_TOKEN"   -H "Content-Type: application/json"   --data-binary @dxp-realm-final.json
